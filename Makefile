...
sum-of-coupling: $(maatGroupsFilePath) $(fileChangesLogFilePath)
...
coupling: $(maatGroupsFilePath) $(fileChangesLogFilePath)
...
authors: $(maatGroupsFilePath) $(fileChangesLogFilePath)
...
entity-ownership: $(maatGroupsFilePath) $(fileChangesLogFilePath)
